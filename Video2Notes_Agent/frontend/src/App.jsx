...
const App = () => {
  return (
    <div className="app-shell min-h-screen overflow-x-hidden selection:bg-cyan-200 selection:text-slate-900" style={{ color: 'var(--ink)' }}>
      ...
      <main className="relative z-10 mx-auto max-w-[1720px] px-4 py-8 sm:px-6 lg:px-8 xl:px-10">
        <Routes>
      ...
      <footer className="relative z-10 mt-20 border-t backdrop-blur-xl" style={{ borderColor: 'var(--border)', background: 'var(--header)' }}>
        <div className="mx-auto flex max-w-[1720px] flex-col gap-3 px-4 py-8 text-sm sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8 xl:px-10">
          <p className="max-w-2xl leading-relaxed app-muted">
            Turn long-form videos into structured notes, study assets, and searchable library entries with reusable caching and a premium study workspace.
          </p>
